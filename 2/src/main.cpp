...
// zmienne stałe pomocnicze
	const double p1 = g * cos(a) * cos(a) / sin(a);
	const double p2 = sin(a)*sin(a);
	const double p3 = g * sin(a) * cos(a) * cos(a);
	const double ep1 = .5*sin(a)*sin(a)/(cos(a)*cos(a));
	const double ep2 = .5/(cos(a)*cos(a));
	const double ep3 = g*sin(a);
